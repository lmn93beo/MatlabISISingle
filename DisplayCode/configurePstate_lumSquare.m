function configurePstate_lumSquare
...
Pstate.param{53} = {'luminance_back'    'float'      127.5       0       ''};
Pstate.param{54} = {'luminance_square'    'float'      255.0     0       ''};
Pstate.param{55} = {'position'   'int'   0       0                ''};
