function configurePstate_RandomDots
...
Pstate.param{6} = {'x_size'      'float'    20       1                'deg'};
Pstate.param{7} = {'y_size'      'float'    20       1                'deg'};
...
Pstate.param{61} = {'bg_x_size'      'float'      30       1                'deg'};
Pstate.param{62} = {'bg_y_size'      'float'      30       1                'deg'};
Pstate.param{63} = {'bg_offset'         'float'      100       0                'deg'};
Pstate.param{64} = {'bg_x_zoom'      'int'   1       0                ''};
Pstate.param{65} = {'bg_y_zoom'      'int'   1       0                ''};
Pstate.param{66} = {'bg_amplitude'      'float'      100      0                 ''};
Pstate.param{67} = {'bg_x_pos'       'int'      600       0                'pixels'};
Pstate.param{68} = {'bg_y_pos'       'int'      400       0                'pixels'};
