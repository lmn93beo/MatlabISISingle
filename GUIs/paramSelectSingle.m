function varargout = paramSelectSingle(varargin)
...
modStrings{6} = 'Random Dots 2';
modStrings{7} = 'Random Dots';
modStrings{8} = 'Periodic Grater 2';
modStrings{9} = 'Luminance Square';
...
global DcomState Mstate Pstate
